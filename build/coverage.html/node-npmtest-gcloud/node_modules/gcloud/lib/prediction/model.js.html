...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/prediction/model.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/prediction/model.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">16% <small>(8 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/prediction/</a> &#187; model.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Model(prediction, id) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(Model, ServiceObject);</span>
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Model.prototype.analyze = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, analysis, resp);</span>
  });
};
&nbsp;
/**
 ...
 * stream.end();
 */
<span class="cstat-no" title="statement not covered" >Model.prototype.createWriteStream = <span class="fstat-no" title="function not covered" >function(label) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  var writeStream = streamEvents(pumpify());</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  writeStream.once('writing', <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    var template = JSON.stringify({</span>
      output: label,
      csvInstance: [[]]
    }).split('[]');
&nbsp;
<span class="cstat-no" title="statement not covered" >    var requestStream = self.request({</span>
      method: 'PUT',
      uri: '',
      headers: {
...
<span class="cstat-no" title="statement not covered" >        writeStream.emit('response', resp);</span>
      })
      .on('prefinish', <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        writeStream.cork();</span>
      })
      .on('complete', <span class="fstat-no" title="function not covered" >function(resp) {</span>
<span class="cstat-no" title="statement not covered" >        util.handleResp(null, resp, resp.body, <span class="fstat-no" title="function not covered" >function(err) {</span></span>
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
<span class="cstat-no" title="statement not covered" >            writeStream.destroy(err);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          writeStream.uncork();</span>
        });
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >    writeStream.setPipeline([</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return writeStream;</span>
};
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Model.prototype.query = <span class="fstat-no" title="function not covered" >function(input, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  this.request({</span>
    method: 'POST',
    uri: '/predict',
    json: {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (resp.outputMulti) {</span>
<span class="cstat-no" title="statement not covered" >      results.scores = resp.outputMulti</span>
        .sort(<span class="fstat-no" title="function not covered" >function(a, b) {</span>
<span class="cstat-no" title="statement not covered" >          return a.score &lt; b.score ? 1 : a.score &gt; b.score ? -1 : 0;</span>
        })
        .map(<span class="fstat-no" title="function not covered" >function(scoreObject) {</span>
<span class="cstat-no" title="statement not covered" >          scoreObject.score = parseFloat(scoreObject.score);</span>
<span class="cstat-no" title="statement not covered" >          return scoreObject;</span>
        });
    }
&nbsp;
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Model.prototype.train = <span class="fstat-no" title="function not covered" >function(label, input, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  this.setMetadata({</span>
    output: label,
    csvInstance: arrify(input)
  }, callback);
};
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = Model;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
