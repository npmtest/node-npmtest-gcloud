...
<div class="header low">
    ...
    <h2>
        ...
        Statements: <span class="metric">30% <small>(15 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * });
 */
Model.prototype.analyze = <span class="fstat-no" title="function not covered" >function(callback) {</span>
 ...
 * stream.end();
 */
Model.prototype.createWriteStream = <span class="fstat-no" title="function not covered" >function(label) {</span>
 ...
 * });
 */
Model.prototype.query = <span class="fstat-no" title="function not covered" >function(input, callback) {</span>
<span class="cstat-no" title="statement not covered" >  this.request({</span>
    method: 'POST',
    uri: '/predict',
    json: {
 ...
 * });
 */
Model.prototype.train = <span class="fstat-no" title="function not covered" >function(label, input, callback) {</span>
