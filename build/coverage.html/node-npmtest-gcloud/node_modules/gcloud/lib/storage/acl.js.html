...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/storage/acl.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/storage/acl.js</span></h1>
    <h2>
        
        Statements: <span class="metric">23.33% <small>(21 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">23.33% <small>(21 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/storage/</a> &#187; acl.js</div>
</div>
<div class="body">
...
561
562
563</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function Acl(options) {</span>
<span class="cstat-no" title="statement not covered" >  AclRoleAccessorMethods.call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.pathPrefix = options.pathPrefix;</span>
<span class="cstat-no" title="statement not covered" >  this.request_ = options.request;</span>
}
&nbsp;
/**
 ...
 * }, function(err, aclObject, apiResponse) {});
 */
Acl.prototype.add = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.generation) {</span>
<span class="cstat-no" title="statement not covered" >    query.generation = options.generation;</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, self.makeAclObject_(resp), resp);</span>
  });
};
&nbsp;
/**
 ...
 * }, function(err, apiResponse) {});
 */
Acl.prototype.delete = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var query = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.generation) {</span>
<span class="cstat-no" title="statement not covered" >    query.generation = options.generation;</span>
 ...
 * }, function(err, aclObject, apiResponse) {});
 */
Acl.prototype.get = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
...
<span class="cstat-no" title="statement not covered" >    path = '/' + encodeURIComponent(options.entity);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (options.generation) {</span>
<span class="cstat-no" title="statement not covered" >      query.generation = options.generation;</span>
    }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (resp.items) {</span>
<span class="cstat-no" title="statement not covered" >      results = arrify(resp.items).map(self.makeAclObject_);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      results = self.makeAclObject_(resp);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, results, resp);</span>
  });
};
&nbsp;
/**
 ...
 * }, function(err, aclObject, apiResponse) {});
 */
Acl.prototype.update = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var query = {};</span>
&nbsp;
 ...
 * @private
 */
Acl.prototype.makeAclObject_ = <span class="fstat-no" title="function not covered" >function(accessControlObject) {</span>
<span class="cstat-no" title="statement not covered" >  var obj = {</span>
    entity: accessControlObject.entity,
    role: accessControlObject.role
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (accessControlObject.projectTeam) {</span>
<span class="cstat-no" title="statement not covered" >    obj.projectTeam = accessControlObject.projectTeam;</span>
  }
&nbsp;
 ...
 * @param {function} callback - The callback function.
 */
Acl.prototype.request = <span class="fstat-no" title="function not covered" >function(reqOpts, callback) {</span>
<span class="cstat-no" title="statement not covered" >  reqOpts.uri = this.pathPrefix + reqOpts.uri;</span>
<span class="cstat-no" title="statement not covered" >  this.request_(reqOpts, callback);</span>
};
&nbsp;
module.exports = Acl;
&nbsp;
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function AclRoleAccessorMethods() {</span>
<span class="cstat-no" title="statement not covered" >  AclRoleAccessorMethods.roles.forEach(this._assignAccessMethods.bind(this));</span>
}
&nbsp;
...
&nbsp;
AclRoleAccessorMethods.prototype._assignAccessMethods = <span class="fstat-no" title="function not covered" >function(role) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var accessMethods = AclRoleAccessorMethods.accessMethods;</span>
<span class="cstat-no" title="statement not covered" >  var entities = AclRoleAccessorMethods.entities;</span>
<span class="cstat-no" title="statement not covered" >  var roleGroup = role.toLowerCase() + 's';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this[roleGroup] = entities.reduce(<span class="fstat-no" title="function not covered" >function(acc, entity) {</span></span>
<span class="cstat-no" title="statement not covered" >    var isPrefix = entity.charAt(entity.length - 1) === '-';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    accessMethods.forEach(<span class="fstat-no" title="function not covered" >function(accessMethod) {</span></span>
<span class="cstat-no" title="statement not covered" >      var method = accessMethod + entity[0].toUpperCase() + entity.substr(1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isPrefix) {</span>
<span class="cstat-no" title="statement not covered" >        method = method.replace('-', '');</span>
      }
&nbsp;
      // Wrap the parent accessor method (e.g. `add` or `delete`) to avoid the
      // more complex API of specifying an `entity` and `role`.
<span class="cstat-no" title="statement not covered" >      acc[method] = <span class="fstat-no" title="function not covered" >function(entityId, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var apiEntity;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (isPrefix) {</span>
<span class="cstat-no" title="statement not covered" >          apiEntity = entity + entityId;</span>
        } else {
          ...
          // a callback.
<span class="cstat-no" title="statement not covered" >          apiEntity = entity;</span>
<span class="cstat-no" title="statement not covered" >          callback = entityId;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        self[accessMethod]({</span>
          entity: apiEntity,
          role: role
        }, callback);
      };
