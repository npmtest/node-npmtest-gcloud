...
<div class="header low">
    ...
    <h2>
        ...
        Lines: <span class="metric">31.37% <small>(16 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * @return {object}
 */
Topic.formatMessage_ = <span class="fstat-no" title="function not covered" >function(message) {</span>
 ...
 * @return {string}
 */
Topic.formatName_ = <span class="fstat-no" title="function not covered" >function(projectId, name) {</span>
 ...
 *   });
 */
Topic.prototype.getSubscriptions = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
 ...
 * ], function(err, messageIds, apiResponse) {});
 */
Topic.prototype.publish = <span class="fstat-no" title="function not covered" >function(messages, callback) {</span>
 ...
 */
Topic.prototype.subscribe = <span class="fstat-no" title="function not covered" >function(subName, options, callback) {</span>
 ...
 * });
 */
Topic.prototype.subscription = <span class="fstat-no" title="function not covered" >function(name, options) {</span>
<span class="cstat-no" title="statement not covered" >  options = options || {};</span>
<span class="cstat-no" title="statement not covered" >  options.topic = this;</span>
&nbsp;
