...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/pubsub/iam.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/pubsub/iam.js</span></h1>
    <h2>
        
        Statements: <span class="metric">28.57% <small>(10 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/pubsub/</a> &#187; iam.js</div>
</div>
<div class="body">
...
256
257
258</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 * // subscription.iam
 */
<span class="fstat-no" title="function not covered" >function IAM(pubsub, id) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  GrpcService.call(this, config, pubsub.options);</span>
}
&nbsp;
 ...
 */
IAM.prototype.getPolicy = <span class="fstat-no" title="function not covered" >function(callback) {</span>
 ...
 */
IAM.prototype.setPolicy = <span class="fstat-no" title="function not covered" >function(policy, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (!is.object(policy)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('A policy object is required.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var protoOpts = {</span>
    service: 'IAMPolicy',
 ...
 * });
 */
IAM.prototype.testPermissions = <span class="fstat-no" title="function not covered" >function(permissions, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (!is.array(permissions) &amp;&amp; !is.string(permissions)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Permissions are required.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  permissions = arrify(permissions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var protoOpts = {</span>
    service: 'IAMPolicy',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var availablePermissions = arrify(resp.permissions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var permissionsHash = permissions.reduce(<span class="fstat-no" title="function not covered" >function(acc, permission) {</span></span>
<span class="cstat-no" title="statement not covered" >      acc[permission] = availablePermissions.indexOf(permission) &gt; -1;</span>
<span class="cstat-no" title="statement not covered" >      return acc;</span>
    }, {});
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, permissionsHash, resp);</span>
  });
};
&nbsp;
module.exports = IAM;
