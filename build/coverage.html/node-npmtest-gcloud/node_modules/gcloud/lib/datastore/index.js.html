...
<div class="header low">
    ...
    <h2>
        ...
        Statements: <span class="metric">43.14% <small>(22 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">43.14% <small>(22 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 */
Datastore.double = <span class="fstat-no" title="function not covered" >function(value) {</span>
 ...
 */
Datastore.geoPoint = <span class="fstat-no" title="function not covered" >function(coordindates) {</span>
 ...
 */
Datastore.int = <span class="fstat-no" title="function not covered" >function(value) {</span>
 ...
 * var query = datastore.createQuery('Company');
 */
Datastore.prototype.createQuery = <span class="fstat-no" title="function not covered" >function(namespace, kind) {</span>
 ...
 * });
 */
Datastore.prototype.key = <span class="fstat-no" title="function not covered" >function(options) {</span>
 ...
 * @private
 */
Datastore.prototype.transaction = <span class="fstat-no" title="function not covered" >function() {</span>
 ...
 */
Datastore.prototype.determineBaseUrl_ = <span class="fstat-no" title="function not covered" >function(customApiEndpoint) {</span>
