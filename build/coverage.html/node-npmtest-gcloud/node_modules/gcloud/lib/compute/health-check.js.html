...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/compute/health-check.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/compute/health-check.js</span></h1>
    <h2>
        
        Statements: <span class="metric">13.16% <small>(5 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/compute/</a> &#187; health-check.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function HealthCheck(compute, name, options) {</span>
...
<span class="cstat-no" title="statement not covered" >  ServiceObject.call(this, {</span>
    ...
    id: name,
    createMethod: <span class="fstat-no" title="function not covered" >function(name, options, callback) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      options = extend({}, options, { https: https });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      compute.createHealthCheck(name, options, callback);</span>
    },
    methods: methods
  });
}
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(HealthCheck, ServiceObject);</span>
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >HealthCheck.prototype.delete = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  var compute = this.compute;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var operation = compute.operation(resp.name);</span>
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >HealthCheck.prototype.setMetadata = <span class="fstat-no" title="function not covered" >function(metadata, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  var compute = this.compute;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  ServiceObject.prototype.setMetadata.call(this, metadata, <span class="fstat-no" title="function not covered" >function(err, resp) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      callback(err, null, resp);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = HealthCheck;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
