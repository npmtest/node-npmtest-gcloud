...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/compute/rule.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/compute/rule.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/compute/</a> &#187; rule.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Rule(scope, name) {</span>
<span class="cstat-no" title="statement not covered" >  var isGlobalRule = scope.constructor.name === 'Compute';</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(Rule, ServiceObject);</span>
&nbsp;
/**
 * Delete the rule.
 *
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Rule.prototype.delete = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var operation = scope.operation(resp.name);</span>
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Rule.prototype.setTarget = <span class="fstat-no" title="function not covered" >function(target, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var scope = this.scope;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = Rule;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
