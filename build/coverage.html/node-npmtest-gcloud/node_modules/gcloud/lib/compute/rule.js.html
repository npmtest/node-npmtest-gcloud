 ...
 * });
 */
Rule.prototype.delete = <span class="fstat-no" title="function not covered" >function(callback) {</span>
 ...
 * });
 */
Rule.prototype.setTarget = <span class="fstat-no" title="function not covered" >function(target, callback) {</span>
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var scope = this.scope;</span>
&nbsp;
