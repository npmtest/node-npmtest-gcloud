...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/bigtable/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/bigtable/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">12.07% <small>(7 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">12.07% <small>(7 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/bigtable/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function Bigtable(options) {</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof Bigtable)) {</span>
<span class="cstat-no" title="statement not covered" >    options = util.normalizeArguments(this, options);</span>
<span class="cstat-no" title="statement not covered" >    return new Bigtable(options);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.clusterName = format(</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(Bigtable, GrpcService);</span>
&nbsp;
/**
 ...
 * // =&gt; 'my-table'
 */
<span class="cstat-no" title="statement not covered" >Bigtable.formatTableName_ = <span class="fstat-no" title="function not covered" >function(name) {</span></span>
 ...
 */
<span class="cstat-no" title="statement not covered" >Bigtable.prototype.createTable = <span class="fstat-no" title="function not covered" >function(name, options, callback) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.operation) {</span>
<span class="cstat-no" title="statement not covered" >    reqOpts.table.currentOperation = options.operation;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.splits) {</span>
<span class="cstat-no" title="statement not covered" >    reqOpts.initialSplitKeys = options.splits;</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var table = self.table(resp.name);</span>
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Bigtable.prototype.getTables = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var protoOpts = {</span>
    service: 'BigtableTableService',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var tables = resp.tables.map(<span class="fstat-no" title="function not covered" >function(metadata) {</span></span>
<span class="cstat-no" title="statement not covered" >      var name = Bigtable.formatTableName_(metadata.name);</span>
<span class="cstat-no" title="statement not covered" >      var table = self.table(name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      table.metadata = metadata;</span>
<span class="cstat-no" title="statement not covered" >      return table;</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, tables, resp);</span>
  });
};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >Bigtable.prototype.table = <span class="fstat-no" title="function not covered" >function(name) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new Table(this, name);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = Bigtable;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
