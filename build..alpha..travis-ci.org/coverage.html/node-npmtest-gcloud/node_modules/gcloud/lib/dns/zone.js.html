...
<div class="header low">
    ...
    <h2>
        ...
        Lines: <span class="metric">19.05% <small>(28 / 147)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * @param {object} callback.apiResponse - Raw API response.
 */
Zone.prototype.addRecords = <span class="fstat-no" title="function not covered" >function(records, callback) {</span>
 ...
 */
Zone.prototype.change = <span class="fstat-no" title="function not covered" >function(id) {</span>
 ...
 * });
 */
Zone.prototype.createChange = <span class="fstat-no" title="function not covered" >function(config, callback) {</span>
 ...
 * });
 */
Zone.prototype.delete = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
 ...
 */
Zone.prototype.deleteRecords = <span class="fstat-no" title="function not covered" >function(records, callback) {</span>
 ...
 * @param {object} callback.apiResponse - Raw API response.
 */
Zone.prototype.empty = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
 ...
 * });
 */
Zone.prototype.export = <span class="fstat-no" title="function not covered" >function(localPath, callback) {</span>
<span class="cstat-no" title="statement not covered" >  this.getRecords(<span class="fstat-no" title="function not covered" >function(err, records) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      callback(err);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
 ...
 *   });
 */
Zone.prototype.getChanges = <span class="fstat-no" title="function not covered" >function(query, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
 ...
 * });
 */
Zone.prototype.getRecords = <span class="fstat-no" title="function not covered" >function(query, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (is.fn(query)) {</span>
<span class="cstat-no" title="statement not covered" >    callback = query;</span>
 ...
 * });
 */
Zone.prototype.import = <span class="fstat-no" title="function not covered" >function(localPath, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
 ...
 * }, function(err, change, apiResponse) {});
 */
Zone.prototype.record = <span class="fstat-no" title="function not covered" >function(type, metadata) {</span>
 ...
 * });
 */
Zone.prototype.replaceRecords = <span class="fstat-no" title="function not covered" >function(recordType, newRecords, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
 ...
 * });
 */
Zone.prototype.deleteRecordsByType_ = <span class="fstat-no" title="function not covered" >function(recordTypes, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
