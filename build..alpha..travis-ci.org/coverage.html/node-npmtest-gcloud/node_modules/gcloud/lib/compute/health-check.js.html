 ...
 * });
 */
HealthCheck.prototype.delete = <span class="fstat-no" title="function not covered" >function(callback) {</span>
 ...
 * });
 */
HealthCheck.prototype.setMetadata = <span class="fstat-no" title="function not covered" >function(metadata, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var compute = this.compute;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
