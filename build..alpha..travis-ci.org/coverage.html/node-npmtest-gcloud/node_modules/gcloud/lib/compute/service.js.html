...
<div class="header low">
    ...
    <h2>
        ...
        Statements: <span class="metric">29.27% <small>(12 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * });
 */
Service.prototype.delete = <span class="fstat-no" title="function not covered" >function(callback) {</span>
 ...
 * });
 */
Service.prototype.getHealth = <span class="fstat-no" title="function not covered" >function(group, callback) {</span>
 ...
 * });
 */
Service.prototype.setMetadata = <span class="fstat-no" title="function not covered" >function(metadata, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var compute = this.compute;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
