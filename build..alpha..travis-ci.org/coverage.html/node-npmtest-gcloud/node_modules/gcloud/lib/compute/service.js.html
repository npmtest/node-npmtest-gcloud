...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/compute/service.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/compute/service.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/compute/</a> &#187; service.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Service(compute, name) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(Service, ServiceObject);</span>
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Service.prototype.delete = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Service.prototype.getHealth = <span class="fstat-no" title="function not covered" >function(group, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  if (!is.string(group)) {</span>
<span class="cstat-no" title="statement not covered" >    group = format('{baseUrl}/projects/{p}/zones/{z}/instanceGroups/{n}', {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, arrify(resp.healthStatus), resp);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Service.prototype.setMetadata = <span class="fstat-no" title="function not covered" >function(metadata, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  var compute = this.compute;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
