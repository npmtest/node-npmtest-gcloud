...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/datastore/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/datastore/index.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">9.8% <small>(5 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/datastore/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * @private
 */
<span class="cstat-no" title="statement not covered" >var entity = require('./entity.js');</span>
&nbsp;
/**
 * @type {module:datastore/query}
 * @private
 */
<span class="cstat-no" title="statement not covered" >var Query = require('./query.js');</span>
&nbsp;
/**
 ...
 * @private
 */
<span class="cstat-no" title="statement not covered" >var Transaction = require('./transaction.js');</span>
&nbsp;
/**
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function Datastore(options) {</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof Datastore)) {</span>
<span class="cstat-no" title="statement not covered" >    options = util.normalizeArguments(this, options, {</span>
      projectIdRequired: false
    });
<span class="cstat-no" title="statement not covered" >    return new Datastore(options);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.defaultBaseUrl_ = 'datastore.googleapis.com';</span>
<span class="cstat-no" title="statement not covered" >  this.determineBaseUrl_(options.apiEndpoint);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.namespace = options.namespace;</span>
<span class="cstat-no" title="statement not covered" >  this.projectId = process.env.DATASTORE_PROJECT_ID || options.projectId;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >modelo.inherits(Datastore, DatastoreRequest, GrpcService);</span>
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >Datastore.double = <span class="fstat-no" title="function not covered" >function(value) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new entity.Double(value);</span>
};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >Datastore.geoPoint = <span class="fstat-no" title="function not covered" >function(coordindates) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new entity.GeoPoint(coordindates);</span>
};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >Datastore.int = <span class="fstat-no" title="function not covered" >function(value) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new entity.Int(value);</span>
};
&nbsp;
/**
 ...
 * @type {string}
 */
<span class="cstat-no" title="statement not covered" >Datastore.MORE_RESULTS_AFTER_CURSOR = 'MORE_RESULTS_AFTER_CURSOR';</span>
&nbsp;
/**
 * This is one of three values which may be returned from
 * {module:datastore#runQuery}, {module:transaction#runQuery}, and
 ...
 * @type {string}
 */
<span class="cstat-no" title="statement not covered" >Datastore.MORE_RESULTS_AFTER_LIMIT = 'MORE_RESULTS_AFTER_LIMIT';</span>
&nbsp;
/**
 * This is one of three values which may be returned from
 * {module:datastore#runQuery}, {module:transaction#runQuery}, and
 ...
 * @type {string}
 */
<span class="cstat-no" title="statement not covered" >Datastore.NO_MORE_RESULTS = 'NO_MORE_RESULTS';</span>
&nbsp;
/**
 ...
 * var query = datastore.createQuery('Company');
 */
<span class="cstat-no" title="statement not covered" >Datastore.prototype.createQuery = <span class="fstat-no" title="function not covered" >function(namespace, kind) {</span></span>
<span class="cstat-no" title="statement not covered" >  if (arguments.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >    kind = arrify(namespace);</span>
<span class="cstat-no" title="statement not covered" >    namespace = this.namespace;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new Query(this, namespace, arrify(kind));</span>
};
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Datastore.prototype.key = <span class="fstat-no" title="function not covered" >function(options) {</span></span>
<span class="cstat-no" title="statement not covered" >  options = is.object(options) ? options : {</span>
    namespace: this.namespace,
    path: arrify(options)
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new entity.Key(options);</span>
};
&nbsp;
/**
 ...
 * @private
 */
<span class="cstat-no" title="statement not covered" >Datastore.prototype.transaction = <span class="fstat-no" title="function not covered" >function() {</span></span>
 ...
 */
<span class="cstat-no" title="statement not covered" >Datastore.prototype.determineBaseUrl_ = <span class="fstat-no" title="function not covered" >function(customApiEndpoint) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (customApiEndpoint) {</span>
<span class="cstat-no" title="statement not covered" >    baseUrl = customApiEndpoint;</span>
<span class="cstat-no" title="statement not covered" >    this.customEndpoint_ = true;</span>
  } else <span class="cstat-no" title="statement not covered" >if (process.env.DATASTORE_EMULATOR_HOST) {</span>
<span class="cstat-no" title="statement not covered" >    baseUrl = process.env.DATASTORE_EMULATOR_HOST;</span>
<span class="cstat-no" title="statement not covered" >    this.customEndpoint_ = true;</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = Datastore;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
