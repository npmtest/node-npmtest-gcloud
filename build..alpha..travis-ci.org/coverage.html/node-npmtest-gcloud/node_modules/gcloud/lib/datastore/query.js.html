...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/datastore/query.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/datastore/query.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25% <small>(13 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/datastore/</a> &#187; query.js</div>
</div>
<div class="body">
...
343
344
345</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function Query(scope, namespace, kinds) {</span>
<span class="cstat-no" title="statement not covered" >  if (!kinds) {</span>
<span class="cstat-no" title="statement not covered" >    kinds = namespace;</span>
<span class="cstat-no" title="statement not covered" >    namespace = null;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.scope = scope;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.namespace = namespace || null;</span>
<span class="cstat-no" title="statement not covered" >  this.kinds = kinds;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.filters = [];</span>
<span class="cstat-no" title="statement not covered" >  this.orders = [];</span>
<span class="cstat-no" title="statement not covered" >  this.groupByVal = [];</span>
<span class="cstat-no" title="statement not covered" >  this.selectVal = [];</span>
&nbsp;
  // pagination
<span class="cstat-no" title="statement not covered" >  this.startVal = null;</span>
<span class="cstat-no" title="statement not covered" >  this.endVal = null;</span>
<span class="cstat-no" title="statement not covered" >  this.limitVal = -1;</span>
<span class="cstat-no" title="statement not covered" >  this.offsetVal = -1;</span>
}
&nbsp;
/**
 ...
 */
Query.prototype.filter = <span class="fstat-no" title="function not covered" >function(property, operator, value) {</span>
<span class="cstat-no" title="statement not covered" >  if (arguments.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >    value = operator;</span>
<span class="cstat-no" title="statement not covered" >    operator = '=';</span>
  }
&nbsp;
  // TODO: Add filter validation.
<span class="cstat-no" title="statement not covered" >  this.filters.push({</span>
    name: property.trim(),
    op: operator.trim(),
    val: value
  });
 ...
 */
Query.prototype.hasAncestor = <span class="fstat-no" title="function not covered" >function(key) {</span>
<span class="cstat-no" title="statement not covered" >  this.filters.push({ name: '__key__', op: 'HAS_ANCESTOR', val: key });</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 * });
 */
Query.prototype.order = <span class="fstat-no" title="function not covered" >function(property, options) {</span>
<span class="cstat-no" title="statement not covered" >  var sign = options &amp;&amp; options.descending ? '-' : '+';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.orders.push({ name: property, sign: sign });</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
Query.prototype.groupBy = <span class="fstat-no" title="function not covered" >function(fieldNames) {</span>
<span class="cstat-no" title="statement not covered" >  this.groupByVal = arrify(fieldNames);</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
Query.prototype.select = <span class="fstat-no" title="function not covered" >function(fieldNames) {</span>
<span class="cstat-no" title="statement not covered" >  this.selectVal = arrify(fieldNames);</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
Query.prototype.start = <span class="fstat-no" title="function not covered" >function(start) {</span>
<span class="cstat-no" title="statement not covered" >  this.startVal = start;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
Query.prototype.end = <span class="fstat-no" title="function not covered" >function(end) {</span>
<span class="cstat-no" title="statement not covered" >  this.endVal = end;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
Query.prototype.limit = <span class="fstat-no" title="function not covered" >function(n) {</span>
<span class="cstat-no" title="statement not covered" >  this.limitVal = n;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
Query.prototype.offset = <span class="fstat-no" title="function not covered" >function(n) {</span>
<span class="cstat-no" title="statement not covered" >  this.offsetVal = n;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 * });
 */
Query.prototype.run = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var query = this;</span>
<span class="cstat-no" title="statement not covered" >  var args = [query].concat([].slice.call(arguments));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.scope.runQuery.apply(this.scope, args);</span>
};
&nbsp;
