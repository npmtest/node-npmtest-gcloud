...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/datastore/transaction.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/datastore/transaction.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/datastore/</a> &#187; transaction.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Transaction(datastore) {</span>
<span class="cstat-no" title="statement not covered" >  this.datastore = datastore;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.projectId = datastore.projectId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.request = datastore.request.bind(datastore);</span>
&nbsp;
  // A queue for entity modifications made during the transaction.
<span class="cstat-no" title="statement not covered" >  this.modifiedEntities_ = [];</span>
&nbsp;
  // Queue the callbacks that process the API responses.
<span class="cstat-no" title="statement not covered" >  this.requestCallbacks_ = [];</span>
&nbsp;
  // Queue the requests to make when we send the transactional commit.
<span class="cstat-no" title="statement not covered" >  this.requests_ = [];</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(Transaction, DatastoreRequest);</span>
&nbsp;
/*! Developer Documentation
 *
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Transaction.prototype.commit = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.skipCommit) {</span>
...
&nbsp;
    ...
    .filter(<span class="fstat-no" title="function not covered" >function(modifiedEntity) {</span>
<span class="cstat-no" title="statement not covered" >      var key = JSON.stringify(modifiedEntity.entity.key);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!keys[key]) {</span>
<span class="cstat-no" title="statement not covered" >        keys[key] = true;</span>
...
<span class="cstat-no" title="statement not covered" >      return a.method &lt; b.method ? 1 : a.method &gt; b.method ? -1 : 0;</span>
    })
&nbsp;
    ...
    .reduce(<span class="fstat-no" title="function not covered" >function(acc, entityObject) {</span>
<span class="cstat-no" title="statement not covered" >      var lastEntityObject = acc[acc.length - 1];</span>
<span class="cstat-no" title="statement not covered" >      var sameMethod = lastEntityObject &amp;&amp;</span>
        entityObject.method === lastEntityObject.method;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!lastEntityObject || !sameMethod) {</span>
<span class="cstat-no" title="statement not covered" >        acc.push(entityObject);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        lastEntityObject.args = lastEntityObject.args.concat(entityObject.args);</span>
      }
&nbsp;
...
&nbsp;
    ...
    .forEach(<span class="fstat-no" title="function not covered" >function(modifiedEntity) {</span>
<span class="cstat-no" title="statement not covered" >      var method = modifiedEntity.method;</span>
<span class="cstat-no" title="statement not covered" >      var args = modifiedEntity.args.reverse();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      DatastoreRequest.prototype[method].call(self, args, util.noop);</span>
    });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      self.rollback(<span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
    ...
    // .delete methods.
<span class="cstat-no" title="statement not covered" >    self.requestCallbacks_.forEach(<span class="fstat-no" title="function not covered" >function(cb) {</span></span>
<span class="cstat-no" title="statement not covered" >      cb(null, resp);</span>
    });
&nbsp;
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Transaction.prototype.createQuery = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  return this.datastore.createQuery.apply(this, arguments);</span>
};
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Transaction.prototype.delete = <span class="fstat-no" title="function not covered" >function(entities) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  arrify(entities).forEach(<span class="fstat-no" title="function not covered" >function(ent) {</span></span>
<span class="cstat-no" title="statement not covered" >    self.modifiedEntities_.push({</span>
      entity: {
        key: ent
      },
      method: 'delete',
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Transaction.prototype.rollback = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.request_(protoOpts, <span class="fstat-no" title="function not covered" >function(err, resp) {</span></span>
<span class="cstat-no" title="statement not covered" >    self.skipCommit = true;</span>
&nbsp;
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Transaction.prototype.run = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callback = callback || util.noop;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.id = resp.transaction;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, self, resp);</span>
  });
};
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Transaction.prototype.save = <span class="fstat-no" title="function not covered" >function(entities) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  arrify(entities).forEach(<span class="fstat-no" title="function not covered" >function(ent) {</span></span>
<span class="cstat-no" title="statement not covered" >    self.modifiedEntities_.push({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = Transaction;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
