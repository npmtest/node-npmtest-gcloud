...
<div class="header low">
    ...
    <h2>
        ...
        Lines: <span class="metric">19.3% <small>(11 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * });
 */
Translate.prototype.detect = <span class="fstat-no" title="function not covered" >function(input, callback) {</span>
 ...
 * });
 */
Translate.prototype.getLanguages = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >  this.request({</span>
    uri: '/languages'
  }, <span class="fstat-no" title="function not covered" >function(err, resp) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
 ...
 * });
 */
Translate.prototype.translate = <span class="fstat-no" title="function not covered" >function(input, options, callback) {</span>
 ...
 */
Translate.prototype.request = <span class="fstat-no" title="function not covered" >function(reqOpts, callback) {</span>
