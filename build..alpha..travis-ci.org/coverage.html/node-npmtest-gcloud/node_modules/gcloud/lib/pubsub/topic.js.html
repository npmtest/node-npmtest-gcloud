...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/pubsub/topic.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/pubsub/topic.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">11.76% <small>(6 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/pubsub/</a> &#187; topic.js</div>
</div>
<div class="body">
...
455
456
457</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function Topic(pubsub, name) {</span>
<span class="cstat-no" title="statement not covered" >  this.name = Topic.formatName_(pubsub.projectId, name);</span>
<span class="cstat-no" title="statement not covered" >  this.pubsub = pubsub;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >nodeutil.inherits(Topic, GrpcServiceObject);</span>
&nbsp;
/**
 ...
 * @return {object}
 */
<span class="cstat-no" title="statement not covered" >Topic.formatMessage_ = <span class="fstat-no" title="function not covered" >function(message) {</span></span>
<span class="cstat-no" title="statement not covered" >  if (!(message.data instanceof Buffer)) {</span>
<span class="cstat-no" title="statement not covered" >    message.data = new Buffer(JSON.stringify(message.data));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  message.data = message.data.toString('base64');</span>
&nbsp;
 ...
 * @return {string}
 */
<span class="cstat-no" title="statement not covered" >Topic.formatName_ = <span class="fstat-no" title="function not covered" >function(projectId, name) {</span></span>
...
<span class="cstat-no" title="statement not covered" >  return 'projects/' + projectId + '/topics/' + name;</span>
};
&nbsp;
/**
 ...
 *   });
 */
<span class="cstat-no" title="statement not covered" >Topic.prototype.getSubscriptions = <span class="fstat-no" title="function not covered" >function(options, callback) {</span></span>
...
<span class="cstat-no" title="statement not covered" >  options.topic = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.pubsub.getSubscriptions(options, callback);</span>
};
&nbsp;
/**
 ...
 * ], function(err, messageIds, apiResponse) {});
 */
<span class="cstat-no" title="statement not covered" >Topic.prototype.publish = <span class="fstat-no" title="function not covered" >function(messages, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  messages = arrify(messages);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (messages.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Cannot publish without a message.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!messages.every(prop('data'))) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Cannot publish message without a `data` property.');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    callback(null, arrify(result.messageIds), result);</span>
  });
};
&nbsp;
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >Topic.prototype.subscribe = <span class="fstat-no" title="function not covered" >function(subName, options, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >  this.pubsub.subscribe(this, subName, options, callback);</span>
};
&nbsp;
/**
 ...
 * });
 */
<span class="cstat-no" title="statement not covered" >Topic.prototype.subscription = <span class="fstat-no" title="function not covered" >function(name, options) {</span></span>
<span class="cstat-no" title="statement not covered" >  options = options || {};</span>
<span class="cstat-no" title="statement not covered" >  options.topic = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.pubsub.subscription(name, options);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = Topic;</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
