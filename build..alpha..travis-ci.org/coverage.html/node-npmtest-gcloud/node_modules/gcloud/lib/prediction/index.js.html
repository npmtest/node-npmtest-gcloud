 ...
 */
Prediction.prototype.createModel = <span class="fstat-no" title="function not covered" >function(id, options, callback) {</span>
 ...
 *   });
 */
Prediction.prototype.getModels = <span class="fstat-no" title="function not covered" >function(query, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
 ...
 */
Prediction.prototype.model = <span class="fstat-no" title="function not covered" >function(id) {</span>
<span class="cstat-no" title="statement not covered" >  if (!id) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('A model ID is required.');</span>
  }
&nbsp;
