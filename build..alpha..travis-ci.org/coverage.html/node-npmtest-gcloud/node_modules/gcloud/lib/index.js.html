...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gcloud/node_modules/gcloud/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gcloud/node_modules/gcloud/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gcloud/node_modules/gcloud/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
451
452
453</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 * });
 */
<span class="fstat-no" title="function not covered" >function gcloud(config) {</span>
<span class="cstat-no" title="statement not covered" >  config = extend(true, { interceptors_: [] }, config);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var gcloudExposedApi = {</span>
    config_: config,
    interceptors: config.interceptors_
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  return Object.keys(apis).reduce(<span class="fstat-no" title="function not covered" >function(gcloudExposedApi, apiName) {</span></span>
<span class="cstat-no" title="statement not covered" >    var Class = apis[apiName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    gcloudExposedApi[apiName] = Class;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return gcloudExposedApi;</span>
  }, gcloudExposedApi);
}
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = extend(gcloud, apis);</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
